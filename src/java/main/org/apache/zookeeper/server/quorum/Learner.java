...
public class Learner {
  ...
  static final private boolean nodelay = System.getProperty("follower.nodelay", "true")
      .equals("true");
  ...
  protected long registerWithLeader(int pktType) throws IOException {
    ...
    if (qp.getType() == Leader.LEADERINFO) {
      ...
      if (newEpoch > self.getAcceptedEpoch()) {
        ...
        throw new IOException("Leaders epoch, " + newEpoch + " is less than accepted epoch, " + self
            .getAcceptedEpoch());
      }
