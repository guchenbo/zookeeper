...
public class Leader {
  ...
  static final private boolean nodelay = System.getProperty("leader.nodelay", "true")
      .equals("true");
  ...
  /**
   * This message type is sent by a follower to pass the last zxid. This is here for backward
   * compatibility purposes.
   */
  final static int FOLLOWERINFO = 11;

  /**
   * This message type is sent by the leader to indicate that the follower is now uptodate andt can
   * start responding to clients.
   */
  final static int UPTODATE = 12;

  /**
   * This message is the first that a follower receives from the leader. It has the protocol version
   * and the epoch of the leader.
   */
  ...
  /**
   * This message type is sent to a leader to request and mutation operation. The payload will
   * consist of a request header followed by a request.
   */
  ...
  /**
   * This message type is sent by a leader to commit a proposal and cause followers to start serving
   * the corresponding data.
   */
  final static int COMMIT = 4;

  /**
   * This message type is enchanged between follower and leader (initiated by follower) to determine
   * liveliness.
   */
  ...
  /**
   * This message is a reply to a synchronize command flushing the pipe between the leader and the
   * follower.
   */
  ...
  static class ToBeAppliedRequestProcessor implements RequestProcessor {
    ...
    /**
     * This request processor simply maintains the toBeApplied list. For this to work next must be a
     * FinalRequestProcessor and FinalRequestProcessor.processRequest MUST process the request
     * synchronously!
     *
